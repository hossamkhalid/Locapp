...
function panelMenu(divId) {
	...
	panel.append('<li data-role="list-divider"><p class="panelTextDivider">LOCAPP</p></li>');
	panel.append('<li data-icon="false"><a class="panelText" href="#indexPage"><img src="./images/icons/ic_action_search.png" class="ui-li-icon largerIcon">Search cards</a></li>');
	panel.append('<li data-icon="false"><a class="panelText" href="#indexPage"><img src="./images/icons/ic_action_home.png" class="ui-li-icon largerIcon">Recent cards</a></li>');
	panel.append('<li data-icon="false"><a class="panelText" href="#indexPage"><img src="./images/icons/ic_action_home.png" class="ui-li-icon largerIcon">Add card</a></li>');
	panel.append('<li data-role="list-divider"><p class="panelTextDivider">&nbsp;</p></li>');
